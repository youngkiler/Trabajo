  ...
  return ( 
        ...
        <div>
            ...
            <div className="flex items-center justify-between py-4">
                ...
                <a href="/product" className="text-white text-sm font-semibold hover:text-purple-600 mr-4">Lista</a>
                <a href="/product/create" className="text-white text-sm font-semibold hover:text-purple-600 mr-4">Agregar</a>
                <a href="/products" className="text-white text-sm font-semibold hover:text-purple-600 mr-4">Disponibles</a> 
                </div>
